...
@section('content')
  <div class="p-4">
    <a href="/user/create"  class="bg-blue-200 text-blue-500 px-3 py-2 hover:bg-blue-300 hover:text-blue-600 rounded">Create User</a>
  </div>  
  ...
  <table class="min-w-full bg-white border border-gray-200">
    <thead class="bg-gray-100">
      <tr>
          ...
          <th scope="col" class="px-6 py-2 text-left border-b border-gray-200"><a href=""
                  class="text-gray-700">Email</a></th>
          <th scope="col" class="px-6 py-2 text-left border-b border-gray-200"><a href="" class="text-gray-700">Action</a></th>
      </tr>
    </thead>
    <tbody>
